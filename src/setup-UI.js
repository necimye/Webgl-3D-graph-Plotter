...
var createUI = {
  ...
  setupSlider: function(selector, options) {
  ...
  createSlider: function(parent, options) {
 ...
 getWidgetId: function() {
  ...
  genCheckbox: function(object, ui) {
    const changeFn = ui.change || noop;
    ui.value = object[ui.key];
    ui.name = ui.name || ui.key;
  ...
  setupUI:function(parent, object, uiInfos) {
    const widgets = {};
  ...
  updateUI: function(widgets, data) {
